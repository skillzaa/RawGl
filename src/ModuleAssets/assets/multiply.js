...
export default function multiply(x = 25, y = 25, width = 50, height = 50, clrBg = null, clrMain = null, lineWidth = 5) {
    ...
    asset.vertices.addDiagonal(5, 100, 5, asset.clrMain.r(), asset.clrMain.g(), asset.clrMain.b());
    asset.vertices.addDiagonal(100, 5, 5, asset.clrMain.r(), asset.clrMain.g(), asset.clrMain.b());
    return asset;
}
